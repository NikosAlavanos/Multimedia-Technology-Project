...
public class Enemy_DeathBringer : Enemy3
{
    #region States
    ...
    public void CastSpell()
    {
        ...
        if (hero.rb.velocity.x != 0)
            xOffset = hero.facingDir * spellOffset.x;

        Vector3 spellPosition = new Vector3(hero.transform.position.x + xOffset, hero.transform.position.y + spellOffset.y);
