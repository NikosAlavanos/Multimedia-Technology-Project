...
public class Inventory : MonoBehaviour
{
    ...
    public Dictionary<ItemData, InventoryItem> inventoryDictionary; //a list with Key and Value
    ...
    {
        for (int i = 0; i < equipmentSlot.Length; i++) //takes each equipment slot and compares it with each item in the equipment Dictionary, if there is then it Updates slot tyoe with the Item
        {
            foreach (KeyValuePair<ItemData_Equipment, InventoryItem> item in equipmentDictionary)
            {
